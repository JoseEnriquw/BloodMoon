...
//                    Debug.Log($"[{name}] Warpeado a NavMesh en: {hit.position}");
//                }
//                else
//                {
//                    Debug.LogError($"[{name}] No se pudo encontrar NavMesh para warpear.");
//                    return;
//                }
//            }
//        }

//        // Activamos la patrulla
...
//            if (agent.hasPath)
//                Debug.Log($"[{name}] Tiene camino al destino.");
//            else
//                Debug.LogWarning($"[{name}] ¡NO tiene camino! ¿Estará el destino fuera del NavMesh?");
//            Debug.Log($"[{name}] Patrullando hacia: {patrolPoints[0].position}");
//        }
//        else
//        {
//            Debug.LogWarning($"[{name}] Error asignando patrulla. Puntos: {patrolPoints?.Length}");
//        }
//    }
